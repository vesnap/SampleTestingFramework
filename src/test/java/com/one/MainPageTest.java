...
public class MainPageTest extends AbstractTestNGSpringContextTests {
    ...
    public Object[][] createDataTest() {
        return new Product[][]{
                ...
                {new Product(4, "Sauce Labs Onesie",
                        ...
                        "$7.99",
                        "ADD TO CART")},
                {new Product(5, "Test.allTheThings() T-Shirt (Red)",
                        "This classic Sauce Labs t-shirt is perfect to wear when cozying up to your keyboard to automate a few tests. Super-soft and comfy ringspun combed cotton.",
                        "$15.99",
                        "ADD TO CART")}};
    }

    @DataProvider(name = "priceLowToHigh")
    public Object[][] createDataTestSort() {
        return new Product[][]{
    ...
    @Test(dataProvider = "defaultOrder",groups="default")
    ...
    @Test(dataProvider = "priceLowToHigh",groups="sortbByPrice")
